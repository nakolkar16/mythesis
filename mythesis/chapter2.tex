...
or topoclusters are seeded by calorimeter cells containing deposited electromagnetic energy of more than
four times its noise threshold. These topo clusters are then expanded by adding cells with electromagnetic
energy of more than twice their noise threshold. This expansion procedure is followed across all the layers
of electromagnetic and hadronic calorimeters. It is finally stopped when cells no longer satisfy the energy
...
algorithm is \mynote{shown in}{Add the pflow figure} 
