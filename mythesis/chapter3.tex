...
\label{sec:tZq}
%==============================================================================
The process of interest for this analysis 
...
\mynote[inline]{}{Do we talk about other decay channels? YES}

Selecting the trilepton decay state has a few advantages. The efficiency of reconstructing leptons is 
higher than that of hadrons. Also, a decay state with three leptons is difficult to replicate by 
background processes. Even though, the branching ratio of the trilepton channel is relatively small,
it shows a clean signature. Due to these reasons, the trilepton channel is chosen for studying the 
...
\begin{itemize}
  ...
  phase space this vetoed while matching matrix element with the parton shower. 
