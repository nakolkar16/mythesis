...
\coordinate[below=1cm of aux1] (aux4); % W W Z

% Definition of boson labels
\coordinate[left=1.5cm of aux3,label=left:$g$] (g);
\coordinate[right=1.5cm of aux4,label=right:$Z$] (Z);
...
% Boson Lines
\draw[photon] (aux1) -- node[label=left:$W$] {} (aux4);
\draw[gluon] (g) -- (aux3);
\draw[photon] (aux4) -- (Z);
\draw[photon] (aux4) -- node[label=left:$W$] {} (aux2);
